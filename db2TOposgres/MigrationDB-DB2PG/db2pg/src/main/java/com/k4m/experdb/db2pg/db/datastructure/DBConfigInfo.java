package com.k4m.experdb.db2pg.db.datastructure;

public class DBConfigInfo implements java.io.Serializable{
	/**
	 * 
	 */
	...
	public DBConfigInfo(String strUSERID, String strDbPw, String strSERVERIP, String strDBNAME, String strPORT, String strSCHEMA_NAME, String strDB_TYPE, String strSERVER_NAME, String strCHARSET, String strHostIP, String strHostUser, String HostUserPWD, int rownum) {
        USERID = strUSERID;
        //USERPW = strUSERPW;
